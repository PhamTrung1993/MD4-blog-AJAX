...
import com.codegym.model.BlogResponse;
    ...
    public ResponseEntity<Blog> create(BlogForm blogForm, BindingResult bindingResult) throws IOException {
        ...
        if (multipartFiles != null) {
            for (MultipartFile multipartFiler : multipartFiles) {
                ...
                image.setBlog(blog);
                FileCopyUtils.copy(multipartFiler.getBytes(), new File(fileUpload +multipartFiler.getOriginalFilename()));
                image.setFile(multipartFiler.getOriginalFilename());
